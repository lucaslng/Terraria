...
class KdTree:
  ...
  def query(this, point: Point):
    ...
    if this.isLeaf():
      pg.draw.rect(SURF, (0,0,0), (this.x_min, this.y_min, this.x_max-this.x_min, this.y_max-this.y_min),width=5)
      if this.point: this.point.draw((0,0,255),5)
      return
    axis = this.depth % 2
    if point[axis] < this.split:
