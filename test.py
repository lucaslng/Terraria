...
cat1 = catSheet.get(9, 144, 16, 16, 200)
cat2 = catSheet.get(40, 144, 16, 16, 200)
cat3 = catSheet.get(71, 144, 16, 16, 200)
cat4 = catSheet.get(103, 144, 16, 16, 200)
cat5 = catSheet.get(135, 144, 16, 16, 200)
cat6 = catSheet.get(167, 144, 16, 16, 200)
cat7 = catSheet.get(200, 144, 16, 16, 200)
cat8 = catSheet.get(232, 144, 16, 16, 200)
# sprites = {
...
while 1:
  ...
  asurf.fill((0,0,0,0))
  asurf.blit(cat5, (0,0))
  asurf.blit(cat6, (0,200))
  asurf.blit(cat7, (200,0))
  asurf.blit(cat8, (200,200))
  surf.blit(asurf, (0,0))
